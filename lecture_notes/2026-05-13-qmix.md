...
> **see paper** · 읽은 날짜: 2026-05-13  
> 분류: MARL · 협업 RL 기초

### 링크
- [Original Paper / Resource](https://scholar.google.com/scholar?q=QMIX+monotonic+value+factorization+(reference))
...
QMIX monotonic value factorization (reference) — classical MARL 개념을 LLM team에 비유.
